...
public class MassiveFoliagePlacer extends FoliagePlacer {
    public static final Codec<MassiveFoliagePlacer> CODEC = RecordCodecBuilder.create(instance ->
            fillFoliagePlacerFields(instance)
                    .and(IntProvider.createValidatingCodec(1, 512).fieldOf("foliage_height").forGetter(MassiveFoliagePlacer::getFoliageHeight))
                    .apply(instance, MassiveFoliagePlacer::new));

    private final IntProvider foliageHeight;

    public MassiveFoliagePlacer(IntProvider radius, IntProvider offset, IntProvider foliageHeight) {
        super(radius, offset);
    ...
    protected FoliagePlacerType<?> getType() {
        return GOTFoliage.MASSIVE_FOLIAGE_PLACER;
    }
