...
public class RedUlthosFoliagePlacer extends FoliagePlacer {
    public static final Codec<RedUlthosFoliagePlacer> CODEC = RecordCodecBuilder.create(instance ->
            fillFoliagePlacerFields(instance)
                    .and(IntProvider.createValidatingCodec(1, 512).fieldOf("foliage_height").forGetter(RedUlthosFoliagePlacer::getFoliageHeight))
                    .apply(instance, RedUlthosFoliagePlacer::new));

    private final IntProvider foliageHeight;

    public RedUlthosFoliagePlacer(IntProvider radius, IntProvider offset, IntProvider foliageHeight) { //2 0 5
        super(radius, offset);
    ...
    protected FoliagePlacerType<?> getType() {
        return GOTFoliage.RED_ULTHOS_FOLIAGE_PLACER;
    }
