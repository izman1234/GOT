...
import net.isaac.got.common.item.weapon.GOTEntities.GOTEntityThrowingAxe;
...
public class GOTItemThrowingAxe extends TridentItem {
    public GOTItemThrowingAxe(Settings settings) {
        super(settings);
    }
    @Override
    public void onStoppedUsing(ItemStack stack, World world, LivingEntity user, int remainingUseTicks) {
        ...
        if (!world.isClient) {
            ...
            if (j == 0) {
                GOTEntityThrowingAxe tridentEntity = new GOTEntityThrowingAxe(world, (LivingEntity)playerEntity, stack);
