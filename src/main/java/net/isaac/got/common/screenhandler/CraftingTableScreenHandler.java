package net.isaac.got.common.screenhandler;
...
public class CraftingTableScreenHandler extends AbstractRecipeScreenHandler<RecipeInputInventory> {
    ...
    public CraftingTableScreenHandler(int syncId, PlayerInventory playerInventory, Block self) {
        this(syncId, playerInventory, ScreenHandlerContext.EMPTY, self);
    }

    public CraftingTableScreenHandler(int syncId, PlayerInventory playerInventory, ScreenHandlerContext context, Block self) {
