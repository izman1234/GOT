    ...
    public static ItemGroup GOTCombatGroup = Registry.register(Registries.ITEM_GROUP, new Identifier(GOT.MOD_ID, "got_combat"),
            FabricItemGroup.builder().displayName(Text.literal("GOT Combat"))
                    .icon(() -> new ItemStack(GOTWeapons.Tormund_Sword)).entries((displayContext, entries) -> {
                        ...
                        entries.add(GOTWeapons.Gregor_Clegane_Sword);
                        entries.add(GOTWeapons.Hearteater);
                        entries.add(GOTWeapons.Heartsbane);
                        entries.add(GOTWeapons.Honor);
                        entries.add(GOTWeapons.Ice);
                        entries.add(GOTWeapons.Jaime_Sword);
                        entries.add(GOTWeapons.Just_Maid);
                        entries.add(GOTWeapons.Indomitable);
                        entries.add(GOTWeapons.Lady_Forlorn);
                        entries.add(GOTWeapons.Lamentation);
                        entries.add(GOTWeapons.Lightbringer);
                        entries.add(GOTWeapons.Longclaw);
                        entries.add(GOTWeapons.Needle);
                        ...
                        entries.add(GOTWeapons.Rhaegar_Sword);
                        entries.add(GOTWeapons.Robb_Sword);
                        ...
                        entries.add(GOTWeapons.Tugar_Khan_Sword);
                        entries.add(GOTWeapons.Tyene_Dagger);
                        entries.add(GOTWeapons.Tyrion_Axe);
                        ...
                        entries.add(GOTWeapons.Sothoryos_Dagger);
                        ...
                        entries.add(GOTWeapons.Westeros_Dagger_Poisoned);
                        entries.add(GOTWeapons.Westeros_Greatsword);
                        entries.add(GOTWeapons.Westeros_Hammer);
                        ...
                        entries.add(GOTWeapons.Yiti_Dagger);
    ...
    public static ItemGroup GOTIngredientsGroup = Registry.register(Registries.ITEM_GROUP, new Identifier(GOT.MOD_ID, "got_ingredients"),
            FabricItemGroup.builder().displayName(Text.literal("GOT Ingredients"))
                    .icon(() -> new ItemStack(GOTOther.Alloy_Steel_Ingot)).entries((displayContext, entries) -> {
                        ...
                        entries.add(GOTOther.Ice_Shard);
